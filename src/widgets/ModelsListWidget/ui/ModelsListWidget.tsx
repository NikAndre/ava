              ...
              <DialogContent style={{width:'618px'}}>
                  <DialogHeader>
                      ...
                      <DialogDescription style={{width:'464px', marginTop: '6px'}}>
                          Это действие приведет к созданию новой модели в статусе “черновик” и автоматическому переходу в меню настройки.
                      </DialogDescription>
                  </DialogHeader>
                  <div style={{
                      display: 'flex',
                      ...
                      <div style={{width: '184px', fontWeight: '500'}}>Название модели</div>
